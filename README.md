...
> [!NOTE]
> **Branch-specific documentation:** this section is maintained for [`dependabot/npm_and_yarn/copy-props-2.0.5`](https://github.com/Nischhalsubba/sassBoilerplate/tree/dependabot/npm_and_yarn/copy-props-2.0.5). It is generated from the files present on this branch and preserves the project-authored README below.
...
```mermaid
flowchart TD
    ROOT["sassBoilerplate / dependabot/npm_and_yarn/copy-props-2.0.5"]
    ROOT --> P0[".vscode/"]
    ROOT --> P1["bin/"]
    ROOT --> P2["src/"]
